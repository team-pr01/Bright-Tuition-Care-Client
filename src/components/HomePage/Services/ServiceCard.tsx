...
const ServiceCard: React.FC<ServiceCardProps> = ({ image, title, description }) => {
  return (
    <div className="bg-white rounded-[10px] font-Nunito w-full xl:w-[360px] h-[370px] flex flex-col gap-4">
      <img src={image} alt={title} className="w-full object-cover h-[235px] rounded-[10px]" />
