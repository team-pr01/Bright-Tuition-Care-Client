...
const AboutUs = () => {
  return (
    <Container>
      <div className="flex flex-col-reverse lg:flex-row font-Nunito h-fit justify-between items-center gap-[44px] my-[50px] ">
        <div className="w-full lg:w-[40%] flex flex-col justify-start">
          <img src={IMAGES.aboutUs} alt="Hero Section" className="" />
        </div>
