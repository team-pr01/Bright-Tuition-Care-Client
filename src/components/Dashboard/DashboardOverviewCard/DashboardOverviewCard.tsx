...
const DashboardOverviewCard: React.FC<TDashboardOverviewCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="size-10 md:size-16 xl:size-12 2xl:size-16 text-lg md:text-2xl rounded-full bg-primary-50/10 md:bg-neutral-20/10 flex items-center justify-center">
        {icon}
      </div>
    </Link>
  );
