...
const TermsAndConditionContents = () => {
  return (
    <div className="max-w-4xl mx-auto p-6">
      {termsData.title && <p className="text-neutral-5 text-3xl font-Nunito font-semibold">{termsData.title}</p>}
      {termsData.sections.map((sec, i) => (
        <div key={i} className="mb-8">
          ...
          {sec.tutorBan && (
            <>
              <h3 className="font-semibold mt-4">A tutor may be banned for:</h3>
              <ul className="list-disc ml-6 space-y-1">
