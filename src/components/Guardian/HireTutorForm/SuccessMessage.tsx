...
const SuccessMessage = () => {
    return (
      ...
      <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
        Thank you for posting your job. Our executive will review it soon and get back to you.
      </p>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8 max-w-md mx-auto">
        <div className="flex items-center justify-center gap-3 mb-3">
          ...
          <span className="text-lg font-semibold text-primary-10">Need Immediate Assistance?</span>
        </div>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-primary-10 hover:bg-primary-10/90 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-200"
        >
