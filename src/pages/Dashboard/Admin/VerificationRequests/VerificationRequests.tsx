...
const VerificationRequests = () => {
  ...
  const verificationRequestsTheads: TableHead[] = [
    ...
    { key: "addressVerificationSentAt", label: "Address Verification Sent At" },
    { key: "addressVerificationCode", label: "Address Verification Code" },
  ...
  const actions: TableAction<any>[] = [
    {
      ...
      onClick: (row) => {
        console.log("View Profile clicked:", row?.id);
        // later: navigate(`/profile/${row?.id}`)
      },
    },
    {
  ...
  const tableData = data?.data?.verificationRequests?.map(
    (verificationRequest: any) => ({
      ...
      userInfo: (
        <div className="space-y-0.5">
          <p className="font-semibold">
            {verificationRequest?.userName || "N/A"}
          </p>
      ...
      addressVerificationSentAt:
        verificationRequest?.addressVerificationSentAt !== null
          ? formatDate(verificationRequest?.addressVerificationSentAt as string)
          : "N/A",
